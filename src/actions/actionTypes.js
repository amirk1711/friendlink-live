...
export const SEND_RESET_LINK_START = 'SEND_RESET_LINK_START';
export const SEND_RESET_LINK_SUCCESS = 'SEND_RESET_LINK_SUCCESS';
export const SEND_RESET_LINK_FAILED = 'SEND_RESET_LINK_FAILED';

export const VALIDATE_RESET_LINK_START = 'VALIDATE_RESET_LINK_START';
export const VALIDATE_RESET_LINK_SUCCESS = 'VALIDATE_RESET_LINK_SUCCESS';
export const VALIDATE_RESET_LINK_FAILED = 'VALIDATE_RESET_LINK_FAILED';
